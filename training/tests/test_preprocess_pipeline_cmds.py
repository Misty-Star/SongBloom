...
class PreprocessPipelineCommandTest(unittest.TestCase):
    def test_build_prepare_assets_cmd_forwards_structure_stage_songformer_args(self):
        ...
        separator_max_files_per_batch=16,
        skip_whisperx=False,
        ...
        whisperx_max_files_per_batch=24,
        ...
        self.assertIn("--separator-python", cmd)
        self.assertIn("python", cmd)
        self.assertIn("--separator-max-files-per-batch", cmd)
        self.assertIn("16", cmd)
        self.assertIn("--whisperx-batch-size", cmd)
        self.assertIn("12", cmd)
        self.assertIn("--whisperx-max-files-per-batch", cmd)
